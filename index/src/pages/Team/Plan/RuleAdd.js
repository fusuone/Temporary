      ...
      >
        <Form layout="vertical">
          <Row gutter={24}>
            ...
            <Col>
              <Form.Item label="上午计划" hasFeedback>
                {getFieldDecorator('ruletype')(<Input.TextArea autosize={{ minRows: 6 }} />)}
              </Form.Item>
            </Col>
            <Col>
              <Form.Item label="下午计划" hasFeedback>
