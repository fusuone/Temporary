export default {
  ...
  'menu.account.setout': '我的积分',
  'menu.account.logout': '退出登录',
  'menu.account.record': '我的考勤',
  'menu.hzz': '货真真',
  'menu.hzz.CommodityShelves':'商品上架',
  'menu.hzz.PrioritySnapping':'入库导入',
  'menu.hzz.sortSwiper':'出库导入',
  'menu.hzz.MakingCoupons':'优惠卷',
  'menu.hzz.FullDiscount':'满减优惠',
  'menu.hzz.AfterService':'售后服务',
  ...
  'app.analysis.total-sales': '本月出仓额',
  'app.analysis.day-sales': '今日出仓额',
  'app.analysis.visits': '客访问量',
  'app.analysis.month-visits': '本月客访量',
  'app.analysis.visits-trend': '访问量趋势',
  'app.analysis.visits-ranking': '访问量类型排名',
  'app.analysis.day-visits': '今日访问量',
  'app.analysis.week': '周同比',
  'app.analysis.day': '日同比',
  'app.analysis.payments': '本月出仓笔数',
  'app.analysis.conversion-rate': '今日出仓笔数',
  'app.analysis.operational-effect': '运营活动效果',
  'app.analysis.sales-trend': '销售趋势',
  'app.analysis.sales-ranking': '商品出仓额TOP 10',
  ...
  // -- 测试
  'menu.test': '测试页',
  'menu.test.data-input': '数据录入',
  'menu.test.upload': '上传',

  // -- 纺织生产
  'menu.textile': '纺织生产',
  // 进胚管理
  'menu.textile.crude': '进胚管理',
  'menu.textile.crude.crudein': ' 进胚录入',
  'menu.textile.crude.check-list': '胚布检查明细',
  // 码单管理
  'menu.textile.track': '码单管理',
  'menu.textile.track.cut': '码单录入',
  'menu.textile.track.list': '码单明细',
  // 送货管理
  'menu.textile.sale': '送货管理',
  'menu.textile.sale.order-list': '出库明细',
  'menu.textile.sale.output': '出库录入',
  // 仓库管理
  'menu.textile.warehouse': '仓库管理',
  'menu.textile.warehouse.ware-list': '转仓明细',
  'menu.textile.warehouse.ware-in': '转仓录入',
  // 基本资料
  'menu.textile.baseinfo': '基本资料',
  'menu.textile.baseinfo.customer': '客户',
  'menu.textile.baseinfo.art': '规格工艺',
  'menu.textile.baseinfo.car': '车型车牌',
  'menu.textile.baseinfo.depot': '仓库设置',
  'menu.textile.baseinfo.worker': '工作人员',

  // -- 仓存管理
  'menu.storehouse': '仓存管理',
  'menu.storehouse.stock-in': '商品进货',
  'menu.storehouse.stock-out': '商品出货',
  'menu.storehouse.stock-return': '商品退货',
  'menu.storehouse.ware-check': '商品盘点',
  'menu.storehouse.ware-setting': '商品设置',
  'menu.storehouse.WarehouseGood':'商品调仓',

  // -- 团队管理
  'menu.team': '团队管理',
  'menu.team.group': '我的团队',
  'menu.team.plan': '工作计划',
  'menu.team.task': '工作任务',
  'menu.team.rule': '积分管理',
  'menu.team.rule.rulein': '积分规则',
  'menu.team.rule.manage': '管理积分',
  'menu.team.expenseaccount': '报销管理',
  'menu.team.expenseaccount.myself-submit': '我提交的报销单',
  'menu.team.expenseaccount.myself-examine': '我审批的报销单',
  'menu.team.Record': '考勤管理',

  //代理商
  'menu.agency': '代理商',
  'menu.agency.management': '代理商管理',
  'menu.agency.statistics': '代理商统计',

  //我的店铺
  // 'menu.shop': '我的店铺',
  // 'menu.shop.preferentialactivity': '优惠活动',
  ...
  // 订单管理
  'menu.mall.bill': '买入订单',
  'menu.mall.bill.all-orders': '全部订单',
  'menu.mall.bill.awaiting-payment': '待付款',
  'menu.mall.bill.awaiting-shipment': '待收货',
  'menu.mall.bill.valuat': '待评论',
  // 'menu.mall.bill.regular-purchase': '我的常购商品',
  'menu.mall.bill.awaiting-send': '待发货',
  'menu.mall.bill.recycling-bin': '订单回收站',
  'menu.mall.release': '发布商品',
  
  'menu.mall.sell-bill': '卖出订单',
  'menu.mall.sell-bill.all-orders': '全部订单',
  'menu.mall.sell-bill.awaiting-payment': '待付款',
  'menu.mall.bill.awaiting-send': '待发货',
  'menu.mall.sell-bill.awaiting-shipment': '待收货',
  'menu.mall.sell-bill.valuat': '待评论',
  // 'menu.mall.sell-bill.regular-purchase': '我的常购商品',
  'menu.mall.sell-bill.recycling-bin': '订单回收站',

  'menu.mall.goods-datum': '商品资料',
  'menu.mall.decoration': '商城装饰',
  'menu.mall.preferentialactivity': '优惠活动',


  //商品管理
  'menu.mall.goods': '商品管理',
  'menu.mall.goods.classification-management': '商品分类管理',
  'menu.mall.goods.brand-management': '商品品牌管理',
  'menu.mall.goods.list-management': '商品列表管理',
  'menu.mall.goods.repertory-management': '库存管理',
  'menu.mall.goods.freight-management': '运费管理',


  //计划
  'menu.plan': '计划',
  'menu.plan.myworkplan': '我的工作计划',
  'menu.plan.teamworkplan': '团队工作计划',

  //商城装饰
  'menu.decoration': '商城装饰',
  'menu.decoration.homepagepicture': '好业绩首页图片',
  'menu.decoration.indexSwiper':'货真真首页广告',
  'menu.decoration.preferentialactivity': '优惠活动',

  //壹软内部 
  'menu.interior': '壹软内部',
  'menu.interior.realname': '实名审核',
  'menu.interior.withdrawcash': '提现审核',
  'menu.interior.withdrawcash.all': '全部',
  'menu.interior.withdrawcash.awaiting-examine': '待审核',
  'menu.interior.withdrawcash.audit-refusal': '审核拒绝',
  'menu.interior.withdrawcash.awaiting-account': '带到账',
  'menu.interior.withdrawcash.arrived-account': '已到账',
  'menu.interior.withdrawcash.failure-pay': '代付失败',
  'menu.interior.withdrawcash.bank-refund': '银行退票',
  'menu.interior.content': '内容审核',
  'menu.interior.receipt': '发票服务',
  'menu.interior.customermining': '客户挖掘',
  'menu.interior.wholesale': '货真真审核',
  // 'menu.interior.decoration': '商城装饰',
  // 'menu.interior.decoration.home-page-picture': '首页图片',
  // 'menu.interior.decoration.preferential-activity': '优惠活动',
