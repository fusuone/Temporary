...
import styles from './TakePassword.less';
...
@connect(({ register, loading }) => ({
  register,
  submitting: loading.effects['takePassword/submit'],
  getCaptchaLoading: loading.effects['takePassword/getCaptcha']
}))
@Form.create()
