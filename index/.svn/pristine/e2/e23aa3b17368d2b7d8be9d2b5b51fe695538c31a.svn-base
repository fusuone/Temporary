...
import styles from './HomePagePicture.less';
...
@Form.create()
class HomePagePicture extends React.PureComponent {
  constructor(props){
  super(props);
  this.state = {
        ...
        <Modal
          ...
          >
            <div className={styles.detailContainer}>
              <p><span>图片：</span><span className="content"> <img style={{width:"180px",height:"100px"}} src={detailModalData.ad_code} alt="img" /></span></p>
